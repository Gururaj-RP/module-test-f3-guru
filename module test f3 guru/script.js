    ...
    async function getData() {
      try {
        const response = await fetch(
          `https://api.geoapify.com/v1/geocode/reverse?lat=${lat}&lon=${long}&format=json&apiKey=a270c26939f44eaaa43fe245e42308c6`
        );
...
function search() {
  ...
  const url = `https://api.geoapify.com/v1/geocode/search?text=${addressInput.value}&apiKey=a270c26939f44eaaa43fe245e42308c6`;

  async function searchData() {
    try {
      const response = await fetch(
        `https://api.geoapify.com/v1/geocode/search?text=${addressInput.value}&apiKey=a270c26939f44eaaa43fe245e42308c6`
      );
